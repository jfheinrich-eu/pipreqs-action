...
def test_action_yml_description_length():
    ...
    ), f"Description is {len(description)} characters, should be <= {max_description_length}"
    ...
    assert (
        "requirements.txt" in description.lower()
    ), "Description should mention requirements.txt"
